...
def cust_pay_log(txt_file):
  ...
  if purchase > paid:
    print(f"{cust_name} under paid for their melons by {purchase - paid}.")

  if purchase < paid:
    print(f"{cust_name} has overpaid for their melons by {paid - purchase}.")

  the_file.close()    

cust_pay_log("customer_orders.txt")